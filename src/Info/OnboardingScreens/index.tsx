        ...
        >
          ...
          >
            <div className="message">
              <h2>Accuracy</h2>
              <p>
                This app uses your phones GPS capability to get your location,
                which you can easily update to ensure your records are highly
                accurate.
              </p>
            </div>
            <div className="credit">
          ...
          >
            <div className="message">
              ...
              <p>
                Online Recording Kernow and Scilly (ORKS) is designed to make it
                as quick and easy as possible for you to submit, store and share
